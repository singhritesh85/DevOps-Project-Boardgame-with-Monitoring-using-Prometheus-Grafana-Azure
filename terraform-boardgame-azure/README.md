...
2. Provide public SSH key in the files custom_data_devopsagent.sh, custom_data_sonarqube.sh, custom_data_blackboxexporter.sh, custom_data_prometheus.sh and custom_data_grafana.sh.
